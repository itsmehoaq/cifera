...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    execute: async (interaction) => {
        ...
        const oldUnixTime = matchRow[columnToIndex(dateColumn)];

        const embed = new EmbedBuilder()
            .setColor("#0099ff")
            .setTitle("Match Reschedule Request")
            .addFields(
                {name: "Team 1 Captain", value: `<@${expectedPlayer1Id}>`, inline: true},
                {name: "Team 2 Captain", value: `<@${expectedPlayer2Id}>`, inline: true},
                {name: "Old time", value: oldUnixTime ? `<t:${Math.floor(oldUnixTime)}:f>` : "N/A", inline: false},
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        {
          name: "Old time",
          value: oldUnixTime ? `<t:${Math.floor(oldUnixTime)}:f>` : "N/A",
          inline: false,
        },
        {
          name: "New time",
